...
<div class="sidebar-menu-container" id="sidebar-menu-container">
	<div class="sidebar-menu-push">
		...
		<div class="sidebar-menu-inner">
			...
			<div class="page-heading news-heading" style='background-image:url({{ asset("images/wallpapernews.jpg") }}) !important;'>
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1>News</h1>
							...
							<div class="classic-posts">
								<div class="single-item">
									...
									<ul>
										...
										<li>By: <em>{{ $post->redacteur->user->name }}</em></li>
										<li>Comments: <em>2</em></li>
									</ul>
									<a href="{{ Route('post.onepage', $post->id) }}"><h4>New University Finder: Compare</h4></a>
									<p>{{ $post->text }}</p>
