    ...
    <section class="home-section p-0">
        <div class='container d-flex flex-column align-items-center justify-content-center'>
            ...
            <form class='w-100 p-3 mt-5 rounded' style='background-color:#A12C2F'
                action='{{ route('commentaire.update', $commentaire->id) }}' method='post' enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-12 d-flex flex-column align-items-center justify-content-center">
                        <div class='d-flex flex-column align-items-start justify-content-center mb-3'>
                            <label class='text-uppercase text-white mb-2' for=''>user</label>
                            <input type='text' name='user' value='{{ $commentaire->user->name }}'>
                        </div>
                        <div class='d-flex flex-column align-items-start justify-content-center mb-3'>
